...
\begin{enumerate}[leftmargin=1.5em]
    ...
    Bunga majemuk dihitung untuk seluruh periode bulat ($n$ tahun), kemudian diterapkan suku bunga tunggal untuk sisa periode pecahan ($k$):
    \begin{equation}
        A(n+k) = A(n)(1 + i \cdot k) = A(0)(1+i)^n(1 + i \cdot k)
    \end{equation}
\end{enumerate}
...
\end{equation*}
Sehingga metode bunga tunggal pada periode pecahan memberikan hasil akumulasi yang sedikit lebih besar (menguntungkan investor).
...
\begin{itemize}
    ...
    \begin{align*}
        A(2) &= 1{,}000 \times (1.12)^2 = \$1{,}254.40 \\
